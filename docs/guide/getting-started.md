...
description: "Step-by-step guide to running Checkgate locally, completing the setup wizard, creating your first flag, and evaluating it in-process — no network call on every isEnabled() — using the Node.js SDK."
---
