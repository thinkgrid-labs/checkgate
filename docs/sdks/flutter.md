...
description: "Use the Checkgate Flutter SDK to evaluate feature flags in-process via Dart FFI — synchronous, no network call per evaluation. Works with Provider, Riverpod, iOS, Android, macOS, Linux, and Windows."
---
